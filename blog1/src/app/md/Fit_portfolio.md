...
## 4. 배운 점 (Insights)
- 이 프로젝트를 통해 프론트엔드 개발자가 사용자 경험(UX)과 기술적 성능(Performance) 사이에서 어떤 역할을 해야 하는지 배웠습니다.
- WebRTC와 같은 복잡한 네트워크 로직부터 미려한 인터랙션 구현까지, 기술적 난이도가 높은 과제들을 해결하며 '안정성'과 '심미성'을 모두 잡는 풀스택(Full-stack) 관점의 엔지니어링 역량을 기를 수 있었습니다.
